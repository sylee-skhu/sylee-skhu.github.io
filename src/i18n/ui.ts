...
export const ui = {
  en: {
    ...
    "research.description": "Core themes my lab explores — each with a short demo.",
    "research.back": "Back to research",
    "research.videoSoon": "Demo video coming soon.",
    "home.viewAllResearch": "View all research →",
  ...
  ko: {
    ...
    "research.title": "연구",
    "research.description": "연구실이 탐구하는 핵심 주제와 데모입니다.",
    "research.back": "연구로 돌아가기",
    "research.videoSoon": "데모 영상은 준비 중입니다.",
    "home.viewAllResearch": "전체 연구 보기 →",
    "courses.title": "강의",
