...
export const ui = {
  en: {
    ...
    "pub.description": "Reverse chronological order.",
    ...
    "people.title": "People",
    "people.description": "Members of the research group.",
    ...
    "cv.interests": "Academic Interests",
    "cv.advisor": "Advisor",
    "cv.dissertation": "Dissertation",
    "personal.title": "Personal",
    "personal.description": "Life outside research — running, games, and a few good things.",
  ...
  ko: {
    ...
    "cv.experience": "경력",
    "cv.awards": "수상",
    "cv.interests": "연구 관심분야",
    "cv.advisor": "지도교수",
    "cv.dissertation": "학위논문",
    "personal.title": "개인",
    "personal.description": "연구 밖의 일상 — 달리기, 게임, 그리고 소소한 즐거움.",
    "common.present": "현재",
