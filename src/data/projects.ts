...
export const projects: ResearchProject[] = [
  ...
  },
  {
    ...
    funder: { en: "Ministry of SMEs and Startups", ko: "중소벤처기업부/중소기업기술정보진흥원" },
    role: PI,
  ...
  },
  {
    ...
    funder: { en: "Ministry of Science and ICT", ko: "과학기술정보통신부/한국연구재단" },
    role: PI,
...
export const getProject = (id: string): ResearchProject | undefined =>
