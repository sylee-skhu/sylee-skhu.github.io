...
export const site = {
  ...
  bio: {
    ...
    ko: [
      ...
      '성공회대학교에 부임하기 전에는 삼성전자 삼성리서치에서 책임연구원으로 근무했습니다. 2018년 연세대학교에서 <a href="https://cilab.yonsei.ac.kr/">김은태 교수님</a>의 지도 아래 박사학위를 받았으며, 학위논문 제목은 <a href="https://uml.yonsei.ac.kr/search/detail/CATTOT000001892463#">「심층 신경망 기반 판별적 특징 학습과 다중 객체 추적에의 응용」</a>입니다.',
